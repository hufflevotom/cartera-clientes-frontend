  ...
  return (
    ...
    >
      ...
      <Row style={{ width: "100%" }}>
        ...
        <Col span={24}>
          <DescriptionItem title="Placa" content={data.placa} />
        </Col>
      </Row>
      <SectionTitleItem>Responsable</SectionTitleItem>
      <Row style={{ width: "100%" }}>
        <Col span={24}>
          <DescriptionItem title="Nombre" content={data.persona} />
        </Col>
        <Col span={24}>
          <DescriptionItem
            title="Fecha de ingreso"
            content={moment(data.fecha_ingreso).format("DD/MM/YYYY")}
          />
        </Col>
        <Col span={12}>
          <div style={{ marginBottom: "20px" }}>
            <p style={{ fontSize: "16px", marginBottom: "15px" }}>Entrega:</p>
            <Image
              src={`${pathPublic}${data.url_foto_entrega}`}
        ...
        <Col span={12}>
          <div style={{ marginBottom: "20px" }}>
            <p style={{ fontSize: "16px", marginBottom: "15px" }}>Recepción:</p>
            <Image
              src={`${pathPublic}${data.url_foto_recepcion}`}
              fallback="data:image/png;base64,"
              style={{
                width: 100,
              }}
