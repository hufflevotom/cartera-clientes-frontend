...
const InfoRegistro = ({ data, show, setShow }) => {
  return (
    <Drawer
      width={1000}
      placement="right"
      ...
      open={show}
    >
      <DrawerTitle title="Registro" icon={<DatabaseTwoTone />} />
      <SectionTitleItem>Detalles</SectionTitleItem>
      <Row style={{ width: "100%" }}>
        <Col span={24}>
          <DescriptionItem title="Valor" content={data.valor} />
        </Col>
        <Col span={24}>
          <DescriptionItem
            title="Fecha"
            content={moment(data.fecha).format("DD/MM/YYYY")}
          />
        </Col>
      </Row>
      {parseFloat(data.valor_gasto) > 0 && (
        <>
          <SectionTitleItem>Gasto</SectionTitleItem>
          <Row style={{ width: "100%" }}>
            <Col span={24}>
              <DescriptionItem title="Valor" content={data.valor_gasto} />
            </Col>
            <Col span={24}>
            ...
            <Col span={24}>
              <div style={{ marginBottom: "20px" }}>
                ...
                <Image
                  src={`${pathPublic}${data.url_imagen}`}
